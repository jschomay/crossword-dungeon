...
describe('xpThreshold', () => {
  it('level 1 → 240', () => expect(xpThreshold(1)).toBe(240));
  it('level 2 → 290', () => expect(xpThreshold(2)).toBe(290));
  it('level 3 → 350', () => expect(xpThreshold(3)).toBe(350));
  it('level 4 → 410', () => expect(xpThreshold(4)).toBe(410));
  it('level 5 → 500', () => expect(xpThreshold(5)).toBe(500));
